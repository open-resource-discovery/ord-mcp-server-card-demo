    ...
    async ({ percentage }) => ({
      content: [{
        ...
        text: JSON.stringify({
          ...
          message: `Oxygen level adjusted to ${percentage}%. Estimated stabilisation time: 12 minutes.`,
        }, null, 2),
      }],
    }),
  );
    ...
    async () => ({
      content: [{
        ...
        text: JSON.stringify({
          ...
          duration_minutes: 8,
          message: "CO2 scrubbers activated. Estimated time to safe levels: 8 minutes.",
        }, null, 2),
      }],
    }),
  );
