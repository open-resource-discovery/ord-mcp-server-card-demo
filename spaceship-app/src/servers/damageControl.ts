    ...
    async ({ section }) => ({
      content: [{
        ...
        text: JSON.stringify({
          ...
          message: `Emergency sealant deployed to section ${section}. Structural patch active in ~45s.`,
        }, null, 2),
      }],
    }),
  );
    ...
    async ({ section }) => ({
      content: [{
        ...
        text: JSON.stringify({
          ...
          message: `Bulkhead closed for section ${section}. Cabin pressure isolated and stable.`,
        }, null, 2),
      }],
    }),
  );
